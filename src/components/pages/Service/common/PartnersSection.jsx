...
const partners = [
    ...
    {
        name: "Google Cloud",
        logo: "https://img.icons8.com/color/600/google-cloud.png",
    },
    {
        name: "AWS",
...
function PartnersSection() {
    return (
        <section
            id="our-partners"
            className="py-20 lg:pt-28 lg:pb-18 bg-secondary"
        >
            <div className="container mx-auto px-4 lg:px-8">
                ...
                <div className="text-center mb-12">
                    ...
                    <h2 className="text-2xl md:text-3xl font-bold text-foreground mb-4">
                        Global IT Infra / Platform provider's enable our
                        customers' complex hybrid IT ecosystems
                    </h2>
                ...
                <div className="text-center mt-20 text-[8px]">
                    <p className="">
                        Disclaimer: Logos used here belong to their respective
